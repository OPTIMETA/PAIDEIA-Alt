...
```
강의 녹음  →  시험 신호 추출  →  2차원 결정 지도  →  오늘의 컷  →  학습 로드맵
```
...
- **세로축은 자신감입니다.** 오늘의 컷에서 당신이 한 번의 선택으로 입력합니다.
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="./docs/media/triage.jpg" alt="오늘의 컷 화면">
      <br><sub><b>오늘의 컷</b> · 시험 확률이 높은 순서로 한 장씩 보여 줍니다. 한 번의 선택으로 자신감과 남길지 버릴지를 함께 정합니다.</sub>
    </td>
    <td align="center" width="50%">
...
| **오늘의 컷** | 오늘의 컷 버튼 | 시험 확률이 높은 순서로 한 장씩, 한 번의 선택으로 자신감과 남길지 버릴지를 정합니다 |
...
| **갭 보기** | 갭 버튼 | 가르친 것과 시험에 나올 것을 견주어, 시험 신호가 없는 토픽을 흐리게 보여 줍니다 |
