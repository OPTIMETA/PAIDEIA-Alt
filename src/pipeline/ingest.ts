...
1) 핵심 토픽을 추출하고 각 토픽의 '시험 출제 확률' examProb(0~1)을 추정하라.
   ...
   ★ 중요: 강의 내용은 대부분 어느 정도 중요해 보이므로 값이 0.7~0.9에 몰리기 쉽다. 그러지 말고
   토픽들끼리 examProb를 상대적으로 '벌려서' 매겨라 — 가장 강조된 토픽만 0.9+로, 그냥 스치듯
   지나간 토픽은 0.2~0.4로. 0~1 구간을 넓게 활용해 우선순위 차이가 분명히 드러나게 하라.
